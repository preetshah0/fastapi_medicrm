...
@router.post(
    "/create",
    dependencies=[Depends(require_permission("roles", action="create"))],
...
@router.get(
    "/all",
    dependencies=[Depends(require_permission("roles", action="view"))],
...
@router.put(
    "/{role_slug}",
    dependencies=[Depends(require_permission("roles", action="edit"))],
    response_model=APIResponse[RoleResponse],
)
...
@router.delete(
    "/{role_slug}",
    dependencies=[Depends(require_permission("roles", action="delete"))],
)
...
@router.post(
    "/{role_slug}/permission/{permission_slug}",
    dependencies=[Depends(require_permission("roles", action="edit"))],
    response_model=APIResponse[RoleResponse],
)
