...
from app.owner.routes.patient_api import router as patient_router, notes_router, reports_router, lab_referral_router
...
router.include_router(lab_referral_router)
