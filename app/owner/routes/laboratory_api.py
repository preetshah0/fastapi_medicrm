...
@router.get(
    "/facility-types",
    dependencies=[Depends(require_permission("external_laboratories", action="view"))],
    response_model=APIResponse[list[LabEnumResponse]],
)
...
@router.post(
    "/create/{branch_id}",
    dependencies=[Depends(require_permission("external_laboratories", action="create"))],
...
@router.put(
    "/{lab_id}",
    dependencies=[Depends(require_permission("external_laboratories", action="edit"))],
    response_model=APIResponse[LabResponse],
)
...
@router.delete(
    "/{lab_id}",
    dependencies=[Depends(require_permission("external_laboratories", action="delete"))],
)
...
@router.post(
    "/{lab_id}/visit",
    dependencies=[Depends(require_permission("external_laboratories", action="create"))],
    response_model=APIResponse[LabVisitResponse],
)
...
@router.get(
    "/{lab_id}/visits",
    dependencies=[Depends(require_permission("external_laboratories", action="view"))],
    response_model=APIResponse[list[LabVisitResponse]],
)
