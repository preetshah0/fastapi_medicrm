...
@router.get("/branch/{branch_id}", response_model=APIResponse[list[MedicalRepsResponse]])
...
@router.post("/{medical_rep_id}/visit", response_model=APIResponse[MedicalRepVisitResponse])
...
@router.get("/{medical_rep_id}/visits", response_model=APIResponse[list[MedicalRepVisitResponse]])
...
@router.get("/{medical_rep_id}/products", response_model=APIResponse[list[str]])
